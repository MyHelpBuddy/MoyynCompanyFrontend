            ...
            <div className='flex justify-start headflex items-center w-90 center'>
                ...
                <div className={`w-100 navbar nav-dash ml-auto ${burgerclicked ? 'nav-active' : ''}`}>
                    <ul className='flex nav w-90 navlist pa0 ma0 items-center'>
                        ...
                        <li className='center list fw5 f7 f6-l'><a className='link gray dim dib' href="/Settings"><p>Settings</p></a></li>
                    </ul>
                </div>
                <div onClick={logoutvalues} className='dicon'><a style={{color:"#6EB6FF"}} href="/" className='gray'><i className="fa fa-sign-out"></i></a></div>
