...
export default function FreeTrialPrompt({name,company}) {
    return (
        <div style={{borderLeft:"2px solid #6EB6FF"}} className="bg-white br2 w-90 center mv4 c-shadow">
