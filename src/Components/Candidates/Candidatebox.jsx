...
export const Candidatebox = ({candidate}) => {
    ...
    useEffect(() => {
        candidate.languagesFormatted.map((val)=> setlang(lang => [...lang, val.language + ", "]))
    }, [candidate])
    ...
    return (
        <div style={{borderLeft:"2px solid #6EB6FF"}} className="ma1 dib ch bg-white pa3 mt3 br3">
            ...
            <div className='flex justify-between items-start mt2-l mt0'>
                ...
                <div className={`flex flex-1 flex-column items-start ${ismobile?'hide':''}`}>
                    ...
                    <p className='ma0 flex-1 mb3 gray f7 f8-m f8-mo'>{lang}</p>
                </div>
                ...
                <div className='h-100 flex-1 w-25-l w-40-m w-30 pr4 mb2 self-center'>
